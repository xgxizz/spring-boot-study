...
/**
 * obs对象 aaaobsbasicdata_20211222
 * 
 * @author ai
 * @date 2021-12-22
 */
public class AaaObsBasicData {
    ...
    public void setCallerPlatform(String callerPlatform) 
    {
        this.callerPlatform = callerPlatform;
    }

    public String getCallerPlatform() 
    {
